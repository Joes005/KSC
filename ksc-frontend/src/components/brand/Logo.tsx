...
export function Logo({ className = "h-14 w-14" }: LogoProps) {
  ...
  return (
    ...
    >
      {/* Outer ring */}
      <circle cx="110" cy="102" r="96" fill="#ffffff" stroke="#071B4A" strokeWidth="7" />
      <circle cx="110" cy="102" r="88" fill="#E9F5F1" stroke="#071B4A" strokeWidth="1.5" />

      {/* Quartering cross */}
      <rect x="102" y="14" width="16" height="176" fill="#071B4A" />
      <rect x="22" y="94" width="176" height="16" fill="#071B4A" />
      ...
      />
      {branding.motto && (
        <text fontSize="9" fill="#071B4A" fontWeight="600" letterSpacing="1">
      ...
      <circle cx="55" cy="48" r="2.5" fill="#F5C400" />
      <path d="M55 42 L76 53" stroke="#F5C400" strokeWidth="2" fill="none" />
      <circle cx="79" cy="54" r="2" fill="#F5C400" />
      {/* small scroll under cap */}
      <rect x="47" y="73" width="16" height="8" rx="1.5" fill="#F5C400" />
      ...
      <g stroke="#071B4A" strokeWidth="3" fill="none" strokeLinecap="round">
        <path d="M165 44 C151 40 143 52 165 60" />
        <path d="M165 44 C179 40 187 52 165 60" />
      </g>
      <line x1="165" y1="46" x2="165" y2="59" stroke="#F5C400" strokeWidth="2" />

      {/* ---- BL QUADRANT · Torch (victory figure) ---- */}
      <path d="M55 136 C47 148 47 157 55 162 C63 157 63 148 55 136 Z" fill="#F5C400" />
      <path d="M45 164 H65 L61 176 H49 Z" fill="#071B4A" />
      <rect x="51" y="176" width="8" height="18" rx="2" fill="#071B4A" />
      ...
      <path d="M151 174 H179 L176 184 L154 184 Z" fill="#071B4A" />
      <path d="M165 160 C158 169 158 173 165 175 C172 173 172 169 165 160 Z" fill="#F5C400" />

      {/* ---- Centre cross medallion · K S C ---- */}
      <circle cx="110" cy="102" r="21" fill="#F5C400" stroke="#ffffff" strokeWidth="2" />
      <text
        x="110"
        y="107"
        textAnchor="middle"
      ...
      {/* ---- Ribbon banner ---- */}
      <rect x="6" y="198" width="208" height="26" rx="4" fill="#C91419" />
      <path d="M0 199 H6 V224 H0 Z M220 199 H214 V224 H220 Z" fill="#C91419" />
      <text
        x="110"
        y="216"
        textAnchor="middle"
