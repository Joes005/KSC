...
export function SectionHeading({
  ...
  return (
    <div
      className={cn(
        title ? "mb-8 sm:mb-10" : "mb-5 sm:mb-6",
        "max-w-3xl",
    ...
    >
      {kicker && (
        <div className={cn(title ? "mb-6" : "mb-0", "flex", align === "center" && "justify-center")}>
      ...
      {title && <div className={cn("mt-5 h-0.5 w-12 rounded-full bg-ksc-sky", align === "center" && "mx-auto")} aria-hidden="true" />}
    </div>
  );
}
