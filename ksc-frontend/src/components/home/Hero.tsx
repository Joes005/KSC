        ...
        <div className="container-site relative grid items-center gap-12 py-14 lg:min-h-[650px] lg:grid-cols-[1.05fr_.95fr] lg:py-16">
          ...
          <div className="relative mx-auto w-full max-w-xl lg:mx-0 lg:justify-self-end">
            ...
            <div className="relative overflow-hidden rounded-3xl border-4 border-white/80 bg-ksc-navy shadow-[0_20px_50px_-12px_rgba(7,27,74,0.35)] backdrop-blur-sm transition-transform duration-500 hover:-translate-y-2">
              <img key={currentImage} src={HERO_IMAGES[currentImage]} alt="Students supported by Karur Study Centre" className="hero-media h-72 w-full object-cover object-top animate-fade-in sm:h-[480px]" />
            ...
            <div className="absolute left-3 top-3 sm:-left-8 sm:top-8 rounded-xl sm:rounded-2xl bg-white/95 sm:bg-white p-2 sm:p-4 shadow-[0_12px_30px_rgba(0,0,0,0.15)] backdrop-blur-md transition-all">
              <div className="flex flex-col items-center justify-center rounded-lg sm:rounded-xl bg-ksc-red px-3 py-1.5 sm:px-5 sm:py-3 text-white">
                <span className="block text-[9px] sm:text-[10px] font-bold uppercase tracking-[.15em] sm:tracking-[.2em] text-white/90">Now open</span>
                <span className="font-heading text-xs sm:text-lg md:text-2xl font-black uppercase tracking-tight">{SITE_CONFIG.admissionYear}</span>
              </div>
            </div>
          </div>
        </div>
