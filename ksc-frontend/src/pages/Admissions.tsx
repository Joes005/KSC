...
export function Admissions() {
  ...
  return (
    <>
      ...
      {/* Steps */}
      <section className="bg-slate-50 py-10 lg:py-10 lg:py-16 border-b-4 border-ksc-yellow">
        <div className="container-site">
          ...
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {ADMISSION_STEPS.map((step, i) => {
              ...
              return (
                <div key={step.step} className="card-hover p-6 text-center bg-white border-2 border-slate-200">
      ...
      {/* Eligibility summary */}
      <section className="bg-slate-50 py-10 lg:py-10 lg:py-16 border-t-4 border-ksc-yellow">
        <div className="container-site">
          ...
          <div className="mx-auto grid max-w-4xl gap-4 sm:grid-cols-2 mt-8">
            {ELIGIBILITY_SUMMARY.map((item) => (
              <div key={item.level} className="card-hover p-6 bg-white border-2 border-slate-200">
      ...
      <section className="bg-white py-10 lg:py-10 lg:py-16 border-t-4 border-ksc-red">
        <div className="container-site grid gap-10 lg:grid-cols-3">
          <div className="lg:col-span-2">
            ...
            />
            <div className="card-hover bg-slate-50 border-2 border-slate-100 p-6 sm:p-8 mt-8">
            ...
            <ul className="space-y-4 mt-8">
              {UNIVERSITIES.map((uni) => (
                <li key={uni.id}>
                  <Link
                    to={`/academic#${uni.id}`}
                    className="card-hover flex items-center justify-between gap-3 p-5 bg-slate-50 border-2 border-slate-100 hover:border-ksc-yellow hover:bg-white"
                  >
                    <span>
